...
#ifndef GOOGLE_PROTOBUF_INCLUDED_app_2fmetrics_2fconfig_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_app_2fmetrics_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_app_2fmetrics_2fconfig_2eproto
...
struct TableStruct_app_2fmetrics_2fconfig_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_app_2fmetrics_2fconfig_2eproto;
namespace xray {
namespace app {
namespace metrics {
class Config;
...
class Config final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xray.app.metrics.Config) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "xray.app.metrics.Config";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_app_2fmetrics_2fconfig_2eproto;
};
...
inline const std::string& Config::tag() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:xray.app.metrics.Config.tag)
...
inline PROTOBUF_ALWAYS_INLINE void Config::set_tag(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xray.app.metrics.Config.tag)
}
inline std::string* Config::mutable_tag() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_tag();
  // @@protoc_insertion_point(field_mutable:xray.app.metrics.Config.tag)
  return _s;
}
...
inline std::string* Config::release_tag() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xray.app.metrics.Config.tag)
...
inline void Config::set_allocated_tag(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xray.app.metrics.Config.tag)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_app_2fmetrics_2fconfig_2eproto_2epb_2eh
