...
#ifndef GOOGLE_PROTOBUF_INCLUDED_transport_2fglobal_2fconfig_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_transport_2fglobal_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_transport_2fglobal_2fconfig_2eproto
...
struct TableStruct_transport_2fglobal_2fconfig_2eproto {
...
class Config final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xray.transport.Config) */ {
 public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_transport_2fglobal_2fconfig_2eproto;
};
...
inline ::xray::transport::internet::TransportConfig* Config::mutable_transport_settings(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:xray.transport.Config.transport_settings)
  return _internal_mutable_transport_settings()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::xray::transport::internet::TransportConfig>* Config::mutable_transport_settings()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:xray.transport.Config.transport_settings)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_transport_settings();
}
inline const ::xray::transport::internet::TransportConfig& Config::transport_settings(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:xray.transport.Config.transport_settings)
  return _internal_transport_settings().Get(index);
}
inline ::xray::transport::internet::TransportConfig* Config::add_transport_settings() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::xray::transport::internet::TransportConfig* _add = _internal_mutable_transport_settings()->Add();
  // @@protoc_insertion_point(field_add:xray.transport.Config.transport_settings)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::xray::transport::internet::TransportConfig>& Config::transport_settings() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:xray.transport.Config.transport_settings)
  return _internal_transport_settings();
}
inline const ::google::protobuf::RepeatedPtrField<::xray::transport::internet::TransportConfig>&
Config::_internal_transport_settings() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.transport_settings_;
}
inline ::google::protobuf::RepeatedPtrField<::xray::transport::internet::TransportConfig>*
Config::_internal_mutable_transport_settings() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.transport_settings_;
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_transport_2fglobal_2fconfig_2eproto_2epb_2eh
