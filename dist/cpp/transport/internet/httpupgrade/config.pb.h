...
#ifndef GOOGLE_PROTOBUF_INCLUDED_transport_2finternet_2fhttpupgrade_2fconfig_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_transport_2finternet_2fhttpupgrade_2fconfig_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_transport_2finternet_2fhttpupgrade_2fconfig_2eproto
...
struct TableStruct_transport_2finternet_2fhttpupgrade_2fconfig_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_transport_2finternet_2fhttpupgrade_2fconfig_2eproto;
namespace xray {
namespace transport {
namespace internet {
...
class Config final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xray.transport.internet.httpupgrade.Config) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "xray.transport.internet.httpupgrade.Config";
  }
  protected:
...
inline const std::string& Config::path() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:xray.transport.internet.httpupgrade.Config.path)
...
inline PROTOBUF_ALWAYS_INLINE void Config::set_path(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xray.transport.internet.httpupgrade.Config.path)
}
inline std::string* Config::mutable_path() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_path();
  // @@protoc_insertion_point(field_mutable:xray.transport.internet.httpupgrade.Config.path)
  return _s;
}
...
inline std::string* Config::release_path() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xray.transport.internet.httpupgrade.Config.path)
...
inline bool Config::accept_proxy_protocol() const {
  // @@protoc_insertion_point(field_get:xray.transport.internet.httpupgrade.Config.accept_proxy_protocol)
...
inline void Config::set_accept_proxy_protocol(bool value) {
  ...
  // @@protoc_insertion_point(field_set:xray.transport.internet.httpupgrade.Config.accept_proxy_protocol)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_transport_2finternet_2fhttpupgrade_2fconfig_2eproto_2epb_2eh
