...
module Xray
  module App
    module Commander
      Config = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("xray.app.commander.Config").msgclass
      ReflectionConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("xray.app.commander.ReflectionConfig").msgclass
    end
  end
end
